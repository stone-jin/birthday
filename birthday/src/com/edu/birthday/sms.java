...
public class sms extends Activity {
	...
	private final String a_name[] = {
			"妈妈", "爸爸", "老婆", "老公", "恋人", "挚友", "朋友", "同事", "同学", "老师", "领导", "员工", "客户", "长辈", "晚辈", "兄弟", "姐妹", "宝宝"
	};
	...
	private final String b_name[] = {
			"方言", "德语", "英语", "韩语", "法语", "西班牙语", "符号语言", "粤语", "繁体", "火星文", "手语"
	};
	...
	private final String c_name[] = {
			"网络文体", "幽默搞笑", "犀利整蛊", "经典祝福", "迟到幸福", "温馨祝福", "藏头诗", "祝寿诗", "诗词风", "生日对联", "红色语录", "影视经典", "广告经典", "商务祝福", "个性回复"
	};
	...
	private final String d_name[] = {
			"腊八节", "元旦节", "春节", "元宵节", "情人节", "愚人节", "母亲节", "儿童节", "父亲节", "端午节", "七夕节", "教师节", "中秋节", "国庆节", "光棍节", "圣诞节" 
	};
