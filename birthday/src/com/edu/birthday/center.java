...
public class center extends Activity {
	...
	public static final int CENTER_TO_BIRTH_INFO = 2;
	...
	OnClickListener onClickListener = new OnClickListener(){
		...
		public void onClick(View v) {
			...
			case R.id.center_mybirthdaybutton:
				if(SharedPrefrencesUtil.getSharedPrefrences("center", "haveSaved", false, getApplicationContext())){
					Intent intent = new Intent(center.this,birth_info.class);
					intent.putExtra("birth_info_by_id", 0);
					startActivityForResult(intent, CENTER_TO_BIRTH_INFO);
				}
				break;
			}
		}
